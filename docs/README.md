...
- URL: https://huggingface.co/spaces/Chris4K/image-transformation
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/image-transformation/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/image-transformation
